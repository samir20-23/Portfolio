    ...
    return (
        <main className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-950 dark:text-white selection:bg-purple-500/30">
            <div className="pt-40 pb-20 px-4   mx-auto" style={{ width: "95%" }}> 
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6 mb-16 bg-gray-100 dark:bg-white/5 p-6 rounded-3xl border border-black/5 dark:border-white/10 backdrop-blur-md">
                    <div className="relative w-full lg:w-96">
                        ...
                        <input
                            ...
                            className="w-full bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl py-4 pl-14 pr-6 outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/20 transition-all text-sm text-gray-950 dark:text-white"
                        />
                    </div>
                        ...
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all border ${activeTab === cat
                                        ...
                                        : "bg-white dark:bg-white/5 border-black/5 dark:border-white/10 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/10 hover:border-black/10 dark:hover:border-white/20"
                                    }`}
                            >
                                {cat}
                            </button>
                ...
                {filteredProjects.length > 0 ? (
                    ...
                    <div className="text-center py-32">
                        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gray-100 dark:bg-white/5 mb-6">
                            <FaFilter className="text-gray-400 dark:text-gray-600 text-2xl" />
                        </div>
                        <p className="text-gray-500 text-xl font-medium">No projects found matching your criteria.</p>
                        <button
                            onClick={() => { setSearch(""); setActiveTab("All"); }}
                            className="mt-6 px-8 py-3 bg-purple-600/10 text-purple-600 dark:text-purple-400 rounded-full hover:bg-purple-600/20 transition-all font-bold"
                        >
                            Clear all filters
                        </button>
                    </div>
