...
export default function ProjectList() {
  ...
  // Show only first 3 on landing page for a cleaner look
  const projects = projectsData.slice(0, 3);

  return (
    <section ref={ref} id="projects" className="scroll-mt-28 mb-28 w-full max-w-6xl px-4">
      <SectionHeading>Recent Projects</SectionHeading>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-8 justify-items-center mt-12">
        {projects.map((proj) => (
