...
export default function About() {
  ...
  return (
    <motion.section
      ref={ref}
      className="mb-24 max-w-[45rem] text-center leading-8 sm:mb-24 scroll-mt-24 w-full px-6 sm:px-8"
      initial={{ opacity: 0, y: 100 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay: 0.175 }}
      id="about"
    >
      <div className="bg-gray-50/50 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-3xl p-8 sm:p-10 shadow-sm dark:shadow-none">
